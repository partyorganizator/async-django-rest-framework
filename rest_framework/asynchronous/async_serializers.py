...
from async_utils import async_property # from async_property import async_property
...
class AsyncBaseSerializer(DRFBaseSerializer):
    """
    Enhanced async base serializer with async property support.
    Provides foundation for async serialization operations.
    """
...
class AsyncSerializer(BaseSerializer, DRFSerializer):
    @async_property
    async def adata(self):
        """
...
class AsyncListSerializer(BaseSerializer, DRFListSerializer):
...
class AsyncModelSerializer(Serializer, DRFModelSerializer):
    async def acreate(self, validated_data):
        """
